...
import {
  ...
  CreditCard, Smartphone, MapPin, Phone, Mail, Clock,
} from 'lucide-react';
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 sm:gap-8">
          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-1">
            ...
            <div className="flex items-center gap-3 mt-4">
              <a href={siteConfig.social.instagram} target="_blank" rel="noopener noreferrer" className="p-2 hover:bg-white/10 rounded-md transition-colors" aria-label="Instagram">
                <Instagram className="h-4 w-4" />
              </a>
              <a href={siteConfig.social.facebook} target="_blank" rel="noopener noreferrer" className="p-2 hover:bg-white/10 rounded-md transition-colors" aria-label="Facebook">
                <Facebook className="h-4 w-4" />
              </a>
              <a href={siteConfig.social.youtube} target="_blank" rel="noopener noreferrer" className="p-2 hover:bg-white/10 rounded-md transition-colors" aria-label="YouTube">
                <Youtube className="h-4 w-4" />
              </a>
              <a href={siteConfig.social.twitter} target="_blank" rel="noopener noreferrer" className="p-2 hover:bg-white/10 rounded-md transition-colors" aria-label="Twitter">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {companyLinks.map((link) => (
                <li key={link.label}>
                  <Link href={link.href} className="text-sm text-white/60 hover:text-brand-accent transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          {/* Categories */}
          <div>
            <h3 className="text-sm font-semibold mb-4 text-white/90">Categories</h3>
            <ul className="space-y-2.5">
          ...
          {/* Contact */}
          <div>
            <h3 className="text-sm font-semibold mb-4 text-white/90">Contact</h3>
