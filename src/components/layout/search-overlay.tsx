        ...
        <div className="max-w-[1280px] mx-auto px-4 lg:px-8 py-6">
          <form onSubmit={handleSubmit} className="relative mb-6">
            ...
            <input
              ...
              className="w-full pl-12 pr-12 py-4 text-lg bg-neutral-50 border border-neutral-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-brand-accent/50 focus:border-brand-accent"
            />
            <button
              type="button"
              onClick={closeSearch}
              className="absolute right-4 top-1/2 -translate-y-1/2 p-1 hover:bg-neutral-200 rounded-md min-w-[44px] min-h-[44px] flex items-center justify-center"
            >
              <X className="h-5 w-5" />
            </button>
          </form>
                ...
                <div className="flex flex-wrap gap-2">
                  {popularSearches.map((term) => (
                    <button
                      ...
                      className="px-4 py-2 text-sm bg-neutral-100 hover:bg-neutral-200 rounded-full text-neutral-700 transition-colors"
                    >
                      {term}
                    </button>
                  ))}
