...
const variantStyles: Record<ButtonVariant, string> = {
  primary: "bg-brand-primary text-white hover:bg-neutral-800 shadow-button",
  secondary:
    "border-[1.5px] border-brand-primary text-brand-primary hover:bg-brand-primary hover:text-white",
  accent: "bg-brand-accent text-brand-primary hover:bg-brand-accent/90",
  ghost: "text-brand-primary hover:bg-neutral-100",
