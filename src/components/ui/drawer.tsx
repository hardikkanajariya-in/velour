...
export function Drawer({
  ...
  const sideStyles = {
    right:
      "right-0 top-0 h-full w-full max-w-[85vw] sm:max-w-md animate-[slideInRight_0.3s_ease-out]",
    left: "left-0 top-0 h-full w-full max-w-[85vw] sm:max-w-md animate-[slideInLeft_0.3s_ease-out]",
    bottom:
      "bottom-0 left-0 w-full max-h-[85vh] rounded-t-2xl animate-[fadeUp_0.3s_ease-out]",
  };
