        ...
        columns={[
          ...
          },
          {
            ...
            render: (item) => {
              ...
              return (
                <div>
                  <p className="text-sm">
                    {user?.name ?? (item.guestName as string) ?? "Guest"}
                  </p>
                  <p className="text-xs text-muted-foreground">
                    {user?.email ?? (item.guestEmail as string) ?? ""}
                  </p>
                </div>
              );
            },
          ...
          },
          {
            ...
            render: (item) => (
              <span className="font-medium">
                {formatPrice(item.total as number)}
              </span>
            ),
          },
          {
          ...
          },
          {
            ...
            render: (item) => {
              ...
              return (
                <Badge
                  variant={color as "default" | "success" | "warning" | "error"}
                >
                  {label}
                </Badge>
              );
