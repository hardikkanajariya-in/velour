...
async function resetAndSeed() {
  try {
    ...
    const menCat = await prisma.category.create({
      data: { name: "Men", slug: "men", description: "Men's clothing", displayOrder: 1 },
    });
    const womenCat = await prisma.category.create({
      data: { name: "Women", slug: "women", description: "Women's clothing", displayOrder: 2 },
    });
    const kidsCat = await prisma.category.create({
      data: { name: "Kids", slug: "kids", description: "Kids' clothing", displayOrder: 3 },
    });
    ...
    const imagePool: Record<string, string[]> = {
      [subCats[0].id]: [unsplash("photo-1521572163474-6864f9cf17ab"), unsplash("photo-1583743814966-8936f5b7be1a"), unsplash("photo-1618354691373-d851c5c3a990"), unsplash("photo-1576566588028-4147f3842f27"), unsplash("photo-1562157873-818bc0726f68"), unsplash("photo-1529374255404-311a2a4f1fd9"), unsplash("photo-1523381294911-8d3cead13475"), unsplash("photo-1523381210434-271e8be1f52b")],
      [subCats[1].id]: [unsplash("photo-1596755094514-f87e34085b2c"), unsplash("photo-1602810318383-e386cc2a3ccf"), unsplash("photo-1503342217505-b0a15ec3261c"), unsplash("photo-1589310243389-96a5483213a8"), unsplash("photo-1620012253295-c15cc3e65df4"), unsplash("photo-1603252109303-2751441dd157")],
      [subCats[2].id]: [unsplash("photo-1542272604-787c3835535d"), unsplash("photo-1541099649105-f69ad21f3246"), unsplash("photo-1475178626620-a4d074967452"), unsplash("photo-1582552938357-32b906df40cb"), unsplash("photo-1604176354204-9268737828e4"), unsplash("photo-1556905055-8f358a7a47b2")],
      [subCats[3].id]: [unsplash("photo-1551028719-00167b16eac5"), unsplash("photo-1591047139829-d91aecb6caea"), unsplash("photo-1548883354-94bcfe321cbb"), unsplash("photo-1520975954732-35dd22299614"), unsplash("photo-1516826957135-700dedea698c"), unsplash("photo-1559551409-dadc959f76b8")],
      [subCats[4].id]: [unsplash("photo-1473966968600-fa801b869a1a"), unsplash("photo-1624378439575-d8705ad7ae80"), unsplash("photo-1506629082955-511b1aa562c8")],
      [subCats[5].id]: [unsplash("photo-1595777457583-95e059d581b8"), unsplash("photo-1572804013309-59a88b7e92f1"), unsplash("photo-1550639525-c97d455acf70"), unsplash("photo-1496747611176-843222e1e57c"), unsplash("photo-1515886657613-9f3515b0c78f"), unsplash("photo-1612336307429-8a898d10e223"), unsplash("photo-1539008835657-9e8e9680c956"), unsplash("photo-1544441893-675973e31985")],
      [subCats[6].id]: [unsplash("photo-1564257631407-4deb1f99d992"), unsplash("photo-1485968579580-b6d095142e6e"), unsplash("photo-1594938298603-c8148c4dae35"), unsplash("photo-1525507119028-ed4c629a60a3"), unsplash("photo-1518622358385-8ea7d0794bf6"), unsplash("photo-1487412720507-e7ab37603c6f")],
      [subCats[7].id]: [unsplash("photo-1583496661160-fb5886a0aaaa"), unsplash("photo-1577900232427-18219b9166a0"), unsplash("photo-1592301933927-35b597393c0a")],
      [subCats[8].id]: [unsplash("photo-1541099649105-f69ad21f3246"), unsplash("photo-1604176354204-9268737828e4"), unsplash("photo-1582418702059-97ebafb35d09"), unsplash("photo-1475178626620-a4d074967452"), unsplash("photo-1584370848010-d7fe6bc767ec"), unsplash("photo-1594633312681-425c7b97ccd1")],
      [subCats[9].id]: [unsplash("photo-1610030469983-98e550d6193c"), unsplash("photo-1609505848912-b7c3b8b4beda"), unsplash("photo-1490114538077-0a7f8cb49891"), unsplash("photo-1596609548086-85bbf8ddb6b9")],
      [subCats[10].id]: [unsplash("photo-1519238263530-99bdd11df2ea"), unsplash("photo-1622290291468-a28f7a7dc6a8"), unsplash("photo-1518831959646-742c3a14ebf7"), unsplash("photo-1543459176-4426b37223ba"), unsplash("photo-1471286174890-9c112ffca5b4"), unsplash("photo-1519689680058-324335c77eba")],
      [subCats[11].id]: [unsplash("photo-1518831959646-742c3a14ebf7"), unsplash("photo-1622290291468-a28f7a7dc6a8"), unsplash("photo-1543459176-4426b37223ba"), unsplash("photo-1471286174890-9c112ffca5b4")],
    };

    const imgCounter: Record<string, number> = {};
    function getProductImages(categoryId: string): string[] {
      const pool = imagePool[categoryId] || [unsplash("photo-1441986300917-64674bd600d8")];
    ...
    interface ProductDef {
      ...
      categoryId: string; brandId: string; basePrice: number; comparePrice: number | null;
      gender: ProductGender; isFeatured: boolean; isNewArrival: boolean; isBestSeller: boolean;
      tags: string[]; colorIndices: number[];
    }
    ...
    for (const def of productDefs) {
      ...
      const product = await prisma.product.create({
        data: {
          ...
          images: {
            create: [
              { url: imgs[0], altText: def.name, isPrimary: true, order: 0 },
              { url: imgs[1], altText: `${def.name} - 2`, isPrimary: false, order: 1 },
              { url: imgs[2], altText: `${def.name} - 3`, isPrimary: false, order: 2 },
            ],
          },
          variants: {
    ...
    await Promise.all([
      prisma.coupon.create({
        data: { code: "WELCOME10", type: "percentage", value: 10, minOrderValue: 999, maxDiscount: 500, usageLimit: 1000, isActive: true, validFrom: new Date(), validUntil: new Date(Date.now() + 365 * 86400000), firstOrderOnly: true },
      }),
      prisma.coupon.create({
        data: { code: "FLAT500", type: "fixed", value: 500, minOrderValue: 2999, isActive: true, validFrom: new Date(), validUntil: new Date(Date.now() + 180 * 86400000) },
      }),
      prisma.coupon.create({
        data: { code: "SUMMER20", type: "percentage", value: 20, minOrderValue: 1999, maxDiscount: 1500, usageLimit: 500, isActive: true, validFrom: new Date(), validUntil: new Date(Date.now() + 90 * 86400000) },
      }),
    ]);
    ...
    await Promise.all([
      prisma.banner.create({
        data: {
          title: "Summer Collection 2025", subtitle: "Up to 40% off on new arrivals",
          image: "https://images.unsplash.com/photo-1490481651871-ab68de25d43d?w=1920&h=700&fit=crop&q=80",
          mobileImage: "https://images.unsplash.com/photo-1490481651871-ab68de25d43d?w=800&h=600&fit=crop&q=80",
          link: "/products?tag=summer", position: "hero", order: 0, isActive: true,
        },
      }),
      prisma.banner.create({
        data: {
          title: "Premium Denim", subtitle: "Crafted from the finest selvedge",
          image: "https://images.unsplash.com/photo-1542272604-787c3835535d?w=1920&h=700&fit=crop&q=80",
          link: "/category/men-jeans", position: "hero", order: 1, isActive: true,
        },
      }),
      prisma.banner.create({
        data: {
          title: "Free Shipping", subtitle: "On orders above ₹1,999",
          image: "https://images.unsplash.com/photo-1441984904996-e0b6ba687e04?w=600&h=300&fit=crop&q=80",
          link: "/products", position: "promo", order: 0, isActive: true,
        },
      }),
    ]);
    ...
    for (let i = 0; i < Math.min(12, createdProducts.length); i++) {
      ...
      await prisma.review.create({
        data: { productId: createdProducts[i].id, userId: customer.id, rating: r.rating, title: r.title, body: r.body, isVerified: true, isApproved: true },
      });
    }
    ...
    await Promise.all([
      prisma.blogPost.create({
        data: {
          title: "Building a Capsule Wardrobe: The Complete Guide", slug: "building-a-capsule-wardrobe",
          ...
          coverImage: "https://images.unsplash.com/photo-1445205170230-053b83016050?w=1200&h=600&fit=crop&q=80",
          author: "VELOUR Editorial", tags: ["fashion", "capsule-wardrobe", "sustainable", "guide"], category: "Style Guide", isPublished: true, publishedAt: new Date(),
        },
      }),
      prisma.blogPost.create({
        data: {
          title: "Summer 2025 Trends You Need to Know", slug: "summer-trends-2025",
          ...
          coverImage: "https://images.unsplash.com/photo-1469334031218-e382a71b716b?w=1200&h=600&fit=crop&q=80",
          author: "VELOUR Editorial", tags: ["trends", "summer", "2025", "fashion"], category: "Trends", isPublished: true, publishedAt: new Date(),
        },
      }),
      prisma.blogPost.create({
        data: {
          title: "Behind the Stitch: How We Source Our Fabrics", slug: "behind-the-stitch",
          ...
          coverImage: "https://images.unsplash.com/photo-1558769132-cb1aea458c5e?w=1200&h=600&fit=crop&q=80",
          author: "VELOUR Editorial", tags: ["behind-the-scenes", "fabric", "quality", "sourcing"], category: "Behind the Scenes", isPublished: true, publishedAt: new Date(),
        },
      }),
    ]);
    ...
    await Promise.all([
      prisma.sizeGuide.create({
        data: {
          category: "tops",
          tableData: { headers: ["Size", "Chest (in)", "Length (in)", "Shoulder (in)"], rows: [["XS", "34-36", "26", "15"], ["S", "36-38", "27", "16"], ["M", "38-40", "28", "17"], ["L", "40-42", "29", "17.5"], ["XL", "42-44", "30", "18"], ["XXL", "44-46", "31", "18.5"]] },
      ...
      prisma.sizeGuide.create({
        data: {
          category: "bottoms",
          tableData: { headers: ["Size", "Waist (in)", "Hip (in)", "Inseam (in)"], rows: [["28", "28", "34", "30"], ["30", "30", "36", "31"], ["32", "32", "38", "32"], ["34", "34", "40", "32"], ["36", "36", "42", "32"], ["38", "38", "44", "33"]] },
    ...
    await prisma.address.create({
      data: {
        userId: customer.id, label: "Home", fullName: "John Doe", phone: "+91-98765-43210",
        line1: "42, Park Avenue", line2: "Near Central Mall", city: "Mumbai", state: "Maharashtra",
    ...
    return NextResponse.json({
      ...
      summary: {
        ...
        categories: 3 + subCats.length,
        coupons: 3,
        banners: 3,
        blogPosts: 3,
        sizeGuides: 2,
        reviews: Math.min(12, createdProducts.length),
      },
    });
  } catch (error: unknown) {
