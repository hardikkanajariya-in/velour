...
async function resetAndSeed() {
  try {
    ...
    const imagePool: Record<string, string[]> = {
      ...
      [subCats[1].id]: [unsplash("photo-1596755094514-f87e34085b2c"), unsplash("photo-1602810318383-e386cc2a3ccf"), unsplash("photo-1598033129183-c4f50c736c10"), unsplash("photo-1589310243389-96a5483213a8"), unsplash("photo-1620012253295-c15cc3e65df4"), unsplash("photo-1603252109303-2751441dd157")],
      [subCats[2].id]: [unsplash("photo-1542272604-787c3835535d"), unsplash("photo-1541099649105-f69ad21f3246"), unsplash("photo-1475178626620-a4d074967452"), unsplash("photo-1582552938357-32b906df40cb"), unsplash("photo-1604176354204-9268737828e4"), unsplash("photo-1565084888279-aca5eced0256")],
      [subCats[3].id]: [unsplash("photo-1551028719-00167b16eac5"), unsplash("photo-1591047139829-d91aecb6caea"), unsplash("photo-1548883354-94bcfe321cbb"), unsplash("photo-1520975954732-35dd22299614"), unsplash("photo-1544923246-77307dd270cb"), unsplash("photo-1559551409-dadc959f76b8")],
      ...
      [subCats[5].id]: [unsplash("photo-1595777457583-95e059d581b8"), unsplash("photo-1572804013309-59a88b7e92f1"), unsplash("photo-1550639525-c97d455acf70"), unsplash("photo-1496747611176-843222e1e57c"), unsplash("photo-1515886657613-9f3515b0c78f"), unsplash("photo-1612336307429-8a898d10e223"), unsplash("photo-1539008835657-9e8e9680c956"), unsplash("photo-1585487000160-6ebcfceb0d44")],
      [subCats[6].id]: [unsplash("photo-1564257631407-4deb1f99d992"), unsplash("photo-1485968579580-b6d095142e6e"), unsplash("photo-1594938298603-c8148c4dae35"), unsplash("photo-1525507119028-ed4c629a60a3"), unsplash("photo-1518622358385-8ea7d0794bf6"), unsplash("photo-1434389677669-e08b4cda3a7a")],
      ...
      [subCats[8].id]: [unsplash("photo-1541099649105-f69ad21f3246"), unsplash("photo-1604176354204-9268737828e4"), unsplash("photo-1582418702059-97ebafb35d09"), unsplash("photo-1475178626620-a4d074967452"), unsplash("photo-1584370848010-d7fe6bc767ec"), unsplash("photo-1565084888279-aca5eced0256")],
      [subCats[9].id]: [unsplash("photo-1610030469983-98e550d6193c"), unsplash("photo-1583391733956-6c78276477e2"), unsplash("photo-1570382667048-23b581258ab6"), unsplash("photo-1614093302611-8efc4de30f10")],
    ...
    await Promise.all([
      prisma.blogPost.create({
        data: {
          ...
          coverImage: "https://images.unsplash.com/photo-1558171813-01eda3b889de?w=1200&h=600&fit=crop&q=80",
