        ...
        <section>
          ...
          <div className="space-y-4 text-sm text-muted-foreground">
            <div className="p-4 bg-surface rounded-card">
              ...
              <p>Enjoy free shipping on all orders above ₹1,999 across India.</p>
            </div>
            <div className="p-4 bg-surface rounded-card">
              <h3 className="font-medium text-foreground mb-2">Standard Shipping</h3>
              <p>₹99 flat rate for orders under ₹1,999. Estimated delivery: 5-7 business days.</p>
            </div>
            <div className="p-4 bg-surface rounded-card">
              <h3 className="font-medium text-foreground mb-2">Express Shipping</h3>
              <p>₹199 for express delivery. Estimated delivery: 2-3 business days.</p>
            </div>
            <p>
              Delivery times may vary based on location and availability. You will receive a tracking
              number via email once your order is shipped.
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-4 text-sm text-muted-foreground">
            ...
            <div className="p-4 bg-surface rounded-card">
              ...
              <p>Refunds are credited to your original payment method. For COD orders, refunds are processed via bank transfer.</p>
            </div>
          </div>
        </section>
