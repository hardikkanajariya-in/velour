...
async function main() {
    ...
    [
      {
        name: "VELOUR",
        slug: "velour",
        description: "Our house brand — premium, minimal, timeless.",
      },
      {
        name: "Urban Thread",
        slug: "urban-thread",
        description: "Street-smart everyday essentials.",
      },
      {
        name: "Luxe Lane",
        slug: "luxe-lane",
        description: "Premium fabrics, elevated basics.",
      },
      {
        name: "Petit Monde",
        slug: "petit-monde",
        description: "Stylish comfort for kids.",
      },
      {
        name: "Studio Noir",
        slug: "studio-noir",
        description: "Dark-toned fashion-forward pieces.",
      },
    ].map((b) =>
  ...
  const productDefs: ProductSeed[] = [
    // Men's T-Shirts (6)
    {
      ...
      description:
        "A wardrobe essential crafted from premium 100% cotton. This classic crew neck offers a relaxed fit perfect for everyday wear.",
      shortDescription: "Premium cotton crew neck tee",
      categoryId: subCats[0].id,
      brandId: brands[0].id,
      basePrice: 1299,
      comparePrice: 1799,
    ...
    },
    {
      ...
      description:
        "Bold graphic prints on soft jersey fabric. Street-ready style with premium comfort.",
      shortDescription: "Graphic print street tee",
      categoryId: subCats[0].id,
      brandId: brands[1].id,
      basePrice: 1499,
      comparePrice: null,
    ...
    },
    {
      ...
      description:
        "A modern take on the henley. Slim fit with waffle-knit texture and button placket detail.",
      shortDescription: "Waffle-knit henley",
      categoryId: subCats[0].id,
      brandId: brands[0].id,
      basePrice: 1899,
      comparePrice: 2499,
    ...
    },
    {
      ...
      description:
        "Pre-washed for that perfectly lived-in feel. Relaxed shoulder drop with a modern boxy silhouette.",
      shortDescription: "Vintage washed boxy tee",
      categoryId: subCats[0].id,
      brandId: brands[4].id,
      basePrice: 1699,
      comparePrice: null,
    ...
    },
    {
      ...
      description:
        "Moisture-wicking fabric keeps you cool during workouts. Lightweight with 4-way stretch.",
      shortDescription: "Athletic dry-fit tee",
      categoryId: subCats[0].id,
      brandId: brands[1].id,
      basePrice: 1599,
      comparePrice: 2199,
    ...
    },
    {
      ...
      description:
        "Refined polo in fine piqué cotton. Perfect for smart-casual occasions.",
      shortDescription: "Classic piqué polo",
      categoryId: subCats[0].id,
      brandId: brands[2].id,
      basePrice: 2299,
      comparePrice: 2999,
    ...
    // Men's Shirts (5)
    {
      ...
      description:
        "The definitive oxford. Woven from Japanese cotton with a modern slightly tapered fit.",
      shortDescription: "Japanese cotton oxford",
      categoryId: subCats[1].id,
      brandId: brands[0].id,
      basePrice: 2999,
      comparePrice: 3999,
      gender: ProductGender.MEN,
      ...
      isNewArrival: false,
      isBestSeller: true,
      tags: ["oxford", "formal", "japanese-cotton"],
      colorIndices: [1, 2, 6],
    },
    {
      name: "Linen Camp Collar",
      slug: "linen-camp-collar",
      description:
        "Relaxed camp collar shirt in breathable pure linen. Perfect for warm weather.",
      shortDescription: "Pure linen camp shirt",
      categoryId: subCats[1].id,
      brandId: brands[0].id,
      basePrice: 2799,
      comparePrice: null,
    ...
    },
    {
      ...
      description:
        "Brushed flannel in a heritage check pattern. Warm, soft, and perfect for layering.",
      shortDescription: "Brushed flannel check",
      categoryId: subCats[1].id,
      brandId: brands[1].id,
      basePrice: 2499,
      comparePrice: 3299,
    ...
    },
    {
      ...
      description:
        "Crisp poplin shirt with a slim silhouette. Features a hidden button-down collar.",
      shortDescription: "Slim formal poplin shirt",
      categoryId: subCats[1].id,
      brandId: brands[2].id,
      basePrice: 3499,
      comparePrice: null,
    ...
    },
    {
      ...
      slug: "denim-shirt-jacket",
      description:
        "Heavyweight denim overshirt that works as a light jacket. Stone-washed finish.",
      shortDescription: "Denim overshirt",
      categoryId: subCats[1].id,
      brandId: brands[4].id,
      basePrice: 3999,
      comparePrice: 4999,
    ...
    // Men's Jeans (4)
    {
      ...
      description:
        "Modern slim taper in rigid selvedge denim. Japanese fabric, Italian hardware.",
      shortDescription: "Selvedge slim tapered",
      categoryId: subCats[2].id,
      brandId: brands[0].id,
      basePrice: 3999,
      comparePrice: 5499,
      gender: ProductGender.MEN,
    ...
    },
    {
      ...
      description:
        "Easy-going straight leg with a relaxed rise. Vintage wash with natural fading.",
      shortDescription: "Relaxed fit straight leg",
      categoryId: subCats[2].id,
      brandId: brands[1].id,
      basePrice: 2999,
      comparePrice: null,
      ...
      isNewArrival: true,
      isBestSeller: false,
      tags: ["relaxed", "straight", "vintage-wash"],
      colorIndices: [2, 3],
    },
    {
      ...
      description:
        "Stretch-denim skinny jeans in jet black. The foundation of any dark wardrobe.",
      shortDescription: "Stretch skinny black",
      categoryId: subCats[2].id,
      brandId: brands[4].id,
      basePrice: 3499,
      comparePrice: 4499,
      ...
      isNewArrival: false,
      isBestSeller: false,
      tags: ["skinny", "stretch", "black"],
      colorIndices: [0],
    },
    {
      name: "Carpenter Work Pants",
      slug: "carpenter-work-pants",
      description:
        "Utility-inspired carpenter jeans with reinforced stitching and tool loop detail.",
      shortDescription: "Carpenter utility jeans",
      categoryId: subCats[2].id,
      brandId: brands[1].id,
      basePrice: 3299,
      comparePrice: null,
      ...
      isNewArrival: false,
      isBestSeller: false,
      tags: ["carpenter", "utility", "workwear"],
      colorIndices: [3, 4],
    },
    ...
    // Men's Jackets (3)
    {
      ...
      description:
        "Genuine lambskin leather biker jacket. Asymmetric zip with quilted shoulder detail.",
      shortDescription: "Lambskin biker jacket",
      categoryId: subCats[3].id,
      brandId: brands[4].id,
      basePrice: 12999,
      comparePrice: 16999,
      gender: ProductGender.MEN,
    ...
    },
    {
      ...
      description:
        "Lightweight quilted bomber with ribbed cuffs and hem. Water-resistant shell.",
      shortDescription: "Quilted bomber",
      categoryId: subCats[3].id,
      brandId: brands[0].id,
      basePrice: 5999,
      comparePrice: 7999,
      ...
      isNewArrival: true,
      isBestSeller: false,
      tags: ["bomber", "quilted", "water-resistant"],
      colorIndices: [0, 2, 4],
    },
    {
      name: "Wool Overcoat",
      slug: "wool-overcoat",
      description:
        "Double-breasted wool-blend overcoat. Long line silhouette for a distinguished look.",
      shortDescription: "Wool-blend overcoat",
      categoryId: subCats[3].id,
      brandId: brands[2].id,
      basePrice: 9999,
      comparePrice: null,
    ...
    // Women's Dresses (6)
    {
      ...
      shortDescription: "Flowing silk wrap dress",
      categoryId: subCats[5].id,
      brandId: brands[2].id,
      basePrice: 6999,
      comparePrice: 8999,
    ...
    },
    {
      ...
      description:
        "Effortless midi dress in organic cotton. Puffed sleeves with a cinched waist.",
      shortDescription: "Organic cotton midi",
      categoryId: subCats[5].id,
      brandId: brands[0].id,
      basePrice: 3999,
      comparePrice: null,
    ...
    },
    {
      ...
      description:
        "The ultimate LBD. Structured bodice with a subtle A-line skirt. Timeless.",
      shortDescription: "Classic little black dress",
      categoryId: subCats[5].id,
      brandId: brands[4].id,
      basePrice: 4999,
      comparePrice: 6499,
    ...
    },
    {
      ...
      description:
        "Floor-length maxi in botanical print. V-neck with a smocked waist and tiered skirt.",
      shortDescription: "Botanical print maxi",
      categoryId: subCats[5].id,
      brandId: brands[0].id,
      basePrice: 4499,
      comparePrice: null,
    ...
    },
    {
      ...
      slug: "bodycon-knit-dress",
      description:
        "Ribbed knit bodycon that hugs in all the right places. Perfect for date night.",
      shortDescription: "Ribbed bodycon dress",
      categoryId: subCats[5].id,
      brandId: brands[4].id,
      basePrice: 3499,
      comparePrice: 4999,
      ...
      isNewArrival: false,
      isBestSeller: false,
      tags: ["bodycon", "knit", "evening"],
      colorIndices: [0, 5],
    },
    {
      name: "Shirt Dress Utility",
      slug: "shirt-dress-utility",
      description:
        "Oversized shirt dress with utility pockets. Belt included for waist definition.",
      shortDescription: "Utility shirt dress",
      categoryId: subCats[5].id,
      brandId: brands[1].id,
      basePrice: 3299,
      comparePrice: null,
      ...
      isNewArrival: false,
      isBestSeller: false,
      tags: ["utility", "shirt-dress", "casual"],
      colorIndices: [3, 4, 6],
    },
    ...
    // Women's Tops (5)
    {
      ...
      description:
        "Luxuriously soft cashmere sweater with a relaxed V-neck. Lightweight and warm.",
      shortDescription: "Pure cashmere V-neck",
      categoryId: subCats[6].id,
      brandId: brands[2].id,
      basePrice: 7999,
      comparePrice: 9999,
      gender: ProductGender.WOMEN,
    ...
    },
    {
      ...
      slug: "satin-camisole",
      description:
        "Delicate satin cami with lace trim. Layered or standalone, always chic.",
      shortDescription: "Lace-trim satin cami",
      categoryId: subCats[6].id,
      brandId: brands[0].id,
      basePrice: 1999,
      comparePrice: null,
      ...
      isNewArrival: true,
      isBestSeller: false,
      tags: ["satin", "camisole", "layering"],
      colorIndices: [0, 1, 5, 7],
    },
    {
      name: "Oversized Blazer",
      slug: "oversized-blazer-women",
      description:
        "Power dressing meets relaxed tailoring. Slightly oversized single-button blazer.",
      shortDescription: "Relaxed oversized blazer",
      categoryId: subCats[6].id,
      brandId: brands[4].id,
      basePrice: 5999,
      comparePrice: 7499,
    ...
    },
    {
      ...
      description:
        "Fitted ribbed crop top in stretch cotton. Pairs perfectly with high-waisted everything.",
      shortDescription: "Ribbed cotton crop top",
      categoryId: subCats[6].id,
      brandId: brands[1].id,
      basePrice: 1299,
      comparePrice: 1799,
    ...
    },
    {
      ...
      slug: "peplum-blouse",
      description:
        "Structured peplum blouse with a sweetheart neckline. From boardroom to brunch.",
      shortDescription: "Sweetheart peplum blouse",
      categoryId: subCats[6].id,
      brandId: brands[0].id,
      basePrice: 2499,
      comparePrice: null,
    ...
    // Women's Jeans (3)
    {
      ...
      description:
        "Flattering high-rise straight leg in premium stretch denim. Vintage-inspired.",
      shortDescription: "High-rise straight leg",
      categoryId: subCats[8].id,
      brandId: brands[0].id,
      basePrice: 3999,
      comparePrice: 4999,
      gender: ProductGender.WOMEN,
      ...
      isNewArrival: false,
      isBestSeller: true,
      tags: ["high-rise", "straight", "premium"],
      colorIndices: [0, 2, 3],
    },
    {
      name: "Mom Jeans Relaxed",
      slug: "mom-jeans-relaxed",
      description:
        "The perfect mom jean. High waist, relaxed through the hip and thigh.",
      shortDescription: "Relaxed mom jeans",
      categoryId: subCats[8].id,
      brandId: brands[1].id,
      basePrice: 2999,
      comparePrice: null,
      ...
      isNewArrival: true,
      isBestSeller: false,
      tags: ["mom-jeans", "relaxed", "high-waist"],
      colorIndices: [2, 3],
    },
    {
      ...
      description:
        "Dramatic wide-leg palazzo jeans in dark indigo wash. Statement denim.",
      shortDescription: "Wide leg palazzo jeans",
      categoryId: subCats[8].id,
      brandId: brands[4].id,
      basePrice: 3499,
      comparePrice: 4499,
      ...
      isNewArrival: false,
      isBestSeller: false,
      tags: ["wide-leg", "palazzo", "statement"],
      colorIndices: [2],
    },
    ...
    // Women's Kurtas (3)
    {
      ...
      description:
        "Handwoven Chanderi silk kurta with intricate zari border. Festive elegance.",
      shortDescription: "Handwoven Chanderi kurta",
      categoryId: subCats[9].id,
      brandId: brands[2].id,
      basePrice: 5999,
      comparePrice: 7999,
      gender: ProductGender.WOMEN,
    ...
    },
    {
      ...
      description:
        "Block-printed cotton kurta in Jaipur heritage prints. Comfortable and stylish.",
      shortDescription: "Block-print cotton kurta",
      categoryId: subCats[9].id,
      brandId: brands[0].id,
      basePrice: 2499,
      comparePrice: 3299,
      ...
      isNewArrival: false,
      isBestSeller: true,
      tags: ["block-print", "cotton", "ethnic"],
      colorIndices: [2, 5, 6],
    },
    {
      ...
      description:
        "Flowing anarkali kurta with matching dupatta. Perfect for festive occasions.",
      shortDescription: "Anarkali with dupatta set",
      categoryId: subCats[9].id,
      brandId: brands[2].id,
      basePrice: 7999,
      comparePrice: null,
    ...
    // Kids (6)
    {
      ...
      slug: "kids-graphic-tee-set",
      description:
        "Fun graphic tee and shorts set for active kids. Soft jersey fabric.",
      shortDescription: "Graphic tee + shorts set",
      categoryId: subCats[10].id,
      brandId: brands[3].id,
      basePrice: 1499,
      comparePrice: 1999,
    ...
    },
    {
      ...
      description:
        "Classic denim dungaree with adjustable straps. Durable and adorable.",
      shortDescription: "Denim dungarees",
      categoryId: subCats[10].id,
      brandId: brands[3].id,
      basePrice: 1999,
      comparePrice: null,
    ...
    },
    {
      ...
      description:
        "Lightweight puffer jacket for chilly days. Water-resistant with fleece lining.",
      shortDescription: "Water-resistant puffer",
      categoryId: subCats[10].id,
      brandId: brands[3].id,
      basePrice: 2999,
      comparePrice: 3999,
      ...
      isNewArrival: false,
      isBestSeller: false,
      tags: ["puffer", "winter", "water-resistant"],
      colorIndices: [0, 2, 4],
    },
    {
      ...
      description:
        "Sweet floral dress with a full skirt and peter pan collar. Made from soft cotton.",
      shortDescription: "Cotton floral dress",
      categoryId: subCats[11].id,
      brandId: brands[3].id,
      basePrice: 1799,
      comparePrice: 2499,
      gender: ProductGender.KIDS,
      ...
      isNewArrival: true,
      isBestSeller: true,
      tags: ["floral", "dress", "cotton"],
      colorIndices: [5, 6, 7],
    },
    {
      name: "Girls Legging Set",
      slug: "girls-legging-set",
      description:
        "Comfy legging and tunic set with playful prints. Stretch cotton for all-day wear.",
      shortDescription: "Legging + tunic set",
      categoryId: subCats[11].id,
      brandId: brands[3].id,
      basePrice: 1299,
      comparePrice: null,
      ...
      isNewArrival: false,
      isBestSeller: false,
      tags: ["legging", "set", "play"],
      colorIndices: [5, 7],
    },
    {
      name: "Kids Hoodie Classic",
      slug: "kids-hoodie-classic",
      description:
        "Cozy fleece-lined hoodie with kangaroo pocket. A playground staple.",
      shortDescription: "Fleece hoodie",
      categoryId: subCats[10].id,
      brandId: brands[3].id,
      basePrice: 1999,
      comparePrice: 2799,
  ...
  const reviewTexts = [
    {
      ...
      body: "Amazing fabric quality and the fit is perfect. Definitely ordering more!",
      rating: 5,
    },
    {
      title: "Great value",
      body: "For the price, this is incredibly well-made. The stitching is impeccable.",
      rating: 4,
    },
    {
      title: "Exceeded expectations",
      body: "The color is exactly as shown. Comfortable to wear all day long.",
      rating: 5,
    },
    {
      title: "Solid purchase",
      body: "Good quality, true to size. Delivery was quick too.",
      rating: 4,
    },
    {
      title: "Will buy again",
      body: "The material feels premium. Washed it twice and it still looks brand new.",
      rating: 5,
    },
    {
      title: "Decent product",
      body: "Good for the price. Fabric could be slightly thicker but overall happy.",
      rating: 3,
    },
  ];
  ...
  await Promise.all([
    prisma.blogPost.upsert({
      ...
      create: {
        ...
        excerpt:
          "Learn how to build a versatile wardrobe with just 30 pieces that work for every occasion.",
        content:
    ...
    prisma.blogPost.upsert({
      ...
      create: {
        ...
        excerpt:
          "From earth tones to oversized silhouettes, these are the trends defining this summer.",
        content:
    ...
    prisma.blogPost.upsert({
      ...
      create: {
        ...
        excerpt:
          "A look inside our fabric sourcing process — from Indian mills to Japanese selvedge houses.",
        content:
